...
exports.nearestToCenter = nearestToCenter;
...
function recomputeCentroids(vectors, assignments, k) {
    ...
    return sums.map((sum, c) => {
        if (counts[c] === 0)
            return sum; // empty cluster, keep as-is
 ...
 */
function kmeanspp(vectors, k, maxIter = 20) {
...
function nearestToCenter(vectors, centroid, k) {
