...
exports.RESONANCE_SIGNATURE_SYSTEM = void 0;
exports.resonanceSignatureUser = resonanceSignatureUser;
exports.parseResonanceSignature = parseResonanceSignature;
...
exports.RESONANCE_SIGNATURE_SYSTEM = `You are the resonance engine for ohm., a platform built around intellectual serendipity and meaningful human encounter.
...
function resonanceSignatureUser(sentence, context) {
    const payload = {
        sentence,
...
function parseResonanceSignature(text) {
    try {
        const parsed = JSON.parse(text);
        const tensions = Array.isArray(parsed.tensions)
            ? parsed.tensions
                .map((tension) => ({
                description: typeof tension?.description === "string"
        ...
        return {
            ...
            resonance_phrases: resonancePhrases.length > 0
                ? resonancePhrases
