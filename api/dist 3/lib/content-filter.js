...
exports.assertContentClean = assertContentClean;
 ...
 */
function assertContentClean(text, contentType = "content") {
    const result = filterContent(text);
    if (result.flagged) {
        const error = new Error(`Your ${contentType} was flagged for potentially objectionable content. Please revise and try again.`);
